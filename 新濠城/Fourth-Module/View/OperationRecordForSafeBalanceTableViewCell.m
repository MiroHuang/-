//
//  OperationRecordForSafeBalanceTableViewCell.m
//  新濠城
//
...
@interface OperationRecordForSafeBalanceTableViewCell ()
...
@end
@implementation OperationRecordForSafeBalanceTableViewCell
...
- (void)setDataModel:(KOperationRecordModel *)dataModel {
    if ([dataModel.handlename isEqualToString:@"保险箱转身上分"]) {
