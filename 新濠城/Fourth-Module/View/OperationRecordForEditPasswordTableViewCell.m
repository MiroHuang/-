//
//  OperationRecordForEditPasswordTableViewCell.m
//  新濠城
//
...
@interface OperationRecordForEditPasswordTableViewCell ()
@property (nonatomic, strong) UILabel *kLabel1;
@property (nonatomic, strong) UILabel *kLabel2;
@end
@implementation OperationRecordForEditPasswordTableViewCell
